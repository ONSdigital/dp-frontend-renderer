...
func TestDomainSetLang(t *testing.T){
	...
	Convey("Welsh domain requested", t, func() {
		So(DomainSetLang("www.ons.gov.uk", "","cy"), ShouldEqual, "https://www.ons.gov.uk")
		So(DomainSetLang("ons.gov.uk", "/foo/bar/baz","cy"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz")
		So(DomainSetLang("https://www.ons.gov.uk", "","cy"), ShouldEqual, "https://www.ons.gov.uk")
		So(DomainSetLang("https://ons.gov.uk", "/foo/bar/baz","cy"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz")
		So(DomainSetLang("www.cy.ons.gov.uk", "","cy"), ShouldEqual, "https://www.ons.gov.uk")
		So(DomainSetLang("cy.ons.gov.uk", "/foo/bar/baz","cy"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz")
		So(DomainSetLang("https://www.cy.ons.gov.uk", "","cy"), ShouldEqual, "https://www.ons.gov.uk")
		So(DomainSetLang("https://cy.ons.gov.uk", "/foo/bar/baz","cy"), ShouldEqual, "https://www.ons.gov.uk/foo/bar/baz")
		So(DomainSetLang("www.foo-bar.baz.co.uk", "","cy"), ShouldEqual, "https://www.foo-bar.baz.co.uk")
		So(DomainSetLang("cy.foo-bar.baz.co.uk", "/foo/bar/baz","cy"), ShouldEqual, "https://www.foo-bar.baz.co.uk/foo/bar/baz")
		So(DomainSetLang("https://www.cy.foo-bar.baz.co.uk", "","cy"), ShouldEqual, "https://www.foo-bar.baz.co.uk")
		So(DomainSetLang("https://cy.foo-bar.baz.co.uk", "/foo/bar/baz","cy"), ShouldEqual, "https://www.foo-bar.baz.co.uk/foo/bar/baz")
	})
