...
// templatesDs_store reads file data from disk. It returns an error on failure.
func templatesDs_store() (*asset, error) {
	path := "/Users/crispinmerriman/Go/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/.DS_Store"
...
func templatesDdDatasetTmpl() (*asset, error) {
	path := "/Users/crispinmerriman/Go/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/dd/dataset.tmpl"
...
// templatesDdDatasetlistTmpl reads file data from disk. It returns an error on failure.
func templatesDdDatasetlistTmpl() (*asset, error) {
	path := "/Users/crispinmerriman/Go/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/dd/datasetList.tmpl"
	name := "templates/dd/datasetList.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
func templatesHomepageTmpl() (*asset, error) {
	path := "/Users/crispinmerriman/Go/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/homepage.tmpl"
...
func templatesMainTmpl() (*asset, error) {
	path := "/Users/crispinmerriman/Go/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/main.tmpl"
...
func templatesPartialsFooterTmpl() (*asset, error) {
	path := "/Users/crispinmerriman/Go/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/partials/footer.tmpl"
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	path := "/Users/crispinmerriman/Go/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/partials/header.tmpl"
