...
func templatesDdSplashTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dd/splash.tmpl", size: 1510, mode: os.FileMode(420), modTime: time.Unix(1487593834, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/header.tmpl", size: 5706, mode: os.FileMode(420), modTime: time.Unix(1487593834, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
