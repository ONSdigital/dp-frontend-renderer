...
func templatesMainTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/main.tmpl", size: 4576, mode: os.FileMode(420), modTime: time.Unix(1477030969, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/header.tmpl", size: 5451, mode: os.FileMode(420), modTime: time.Unix(1478678474, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
