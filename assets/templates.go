...
func templatesDdDatasetlistTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dd/datasetList.tmpl", size: 395, mode: os.FileMode(420), modTime: time.Unix(1484841264, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/header.tmpl", size: 5695, mode: os.FileMode(420), modTime: time.Unix(1485166711, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
