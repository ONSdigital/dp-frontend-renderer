...
func templatesMainTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/main.tmpl", size: 3690, mode: os.FileMode(420), modTime: time.Unix(1480001286, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/header.tmpl", size: 5673, mode: os.FileMode(420), modTime: time.Unix(1480503392, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
