...
func templatesPartialsFooterTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/footer.tmpl", size: 2545, mode: os.FileMode(420), modTime: time.Unix(1502184524, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/header.tmpl", size: 6079, mode: os.FileMode(420), modTime: time.Unix(1502187769, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
