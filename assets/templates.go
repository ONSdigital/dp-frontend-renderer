...
func templatesDdDisabledTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dd/disabled.tmpl", size: 696, mode: os.FileMode(420), modTime: time.Unix(1486399963, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesDdSplashTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dd/splash.tmpl", size: 1250, mode: os.FileMode(420), modTime: time.Unix(1485776913, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
