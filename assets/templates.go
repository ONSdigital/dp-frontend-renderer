...
func templatesDdDatasetlistTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dd/datasetList.tmpl", size: 395, mode: os.FileMode(420), modTime: time.Unix(1485335476, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesDdSplashTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dd/splash.tmpl", size: 552, mode: os.FileMode(420), modTime: time.Unix(1485336219, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
