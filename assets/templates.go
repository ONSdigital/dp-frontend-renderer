...
func templatesMainTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/main.tmpl", size: 3690, mode: os.FileMode(420), modTime: time.Unix(1479913040, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/header.tmpl", size: 5426, mode: os.FileMode(420), modTime: time.Unix(1480000818, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
