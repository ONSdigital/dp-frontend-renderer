...
func templatesMainTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/main.tmpl", size: 2285, mode: os.FileMode(420), modTime: time.Unix(1488458473, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/partials/header.tmpl", size: 5706, mode: os.FileMode(420), modTime: time.Unix(1488458473, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
