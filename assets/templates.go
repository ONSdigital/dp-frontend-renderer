...
// templatesDdDatasetTmpl reads file data from disk. It returns an error on failure.
func templatesDdDatasetTmpl() (*asset, error) {
	path := "/Users/neil/goworkspace/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/dd/dataset.tmpl"
	name := "templates/dd/dataset.tmpl"
...
// templatesDdHomepageTmpl reads file data from disk. It returns an error on failure.
func templatesDdHomepageTmpl() (*asset, error) {
	path := "/Users/neil/goworkspace/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/dd/homepage.tmpl"
	name := "templates/dd/homepage.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templatesHomepageTmpl reads file data from disk. It returns an error on failure.
func templatesHomepageTmpl() (*asset, error) {
	path := "/Users/neil/goworkspace/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/homepage.tmpl"
	name := "templates/homepage.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
func templatesMainTmpl() (*asset, error) {
	path := "/Users/neil/goworkspace/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/main.tmpl"
...
func templatesPartialsFooterTmpl() (*asset, error) {
	path := "/Users/neil/goworkspace/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/partials/footer.tmpl"
...
func templatesPartialsHeaderTmpl() (*asset, error) {
	path := "/Users/neil/goworkspace/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/partials/header.tmpl"
...
func templatesProductpageTmpl() (*asset, error) {
	path := "/Users/neil/goworkspace/src/github.com/ONSdigital/dp-frontend-renderer/assets/templates/productPage.tmpl"
